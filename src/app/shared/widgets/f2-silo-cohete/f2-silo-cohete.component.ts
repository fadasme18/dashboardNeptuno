...
@Component({
  selector: 'app-f2-silo-cohete',
  templateUrl: './f2-silo-cohete.component.html',
  styleUrls: ['./f2-silo-cohete.component.scss']
})
export class F2SiloCoheteComponent implements OnInit, OnDestroy {
  ...
  async loadData() {
    ...
    if (this.startDate && this.endDate) {
      this.data = await this.InfluxdbService.F2_silo_cohete(this.startDate, this.endDate);
